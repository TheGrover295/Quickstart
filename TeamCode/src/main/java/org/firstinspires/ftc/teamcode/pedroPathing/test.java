...
public class test extends OpMode {
    ...
    private final Pose startPose = new Pose(56, 8, Math.toRadians(-180)); // Start Pose from visualizer
    private final Pose endPose = new Pose(56, 56, Math.toRadians(90)); // End Pose from visualizer
