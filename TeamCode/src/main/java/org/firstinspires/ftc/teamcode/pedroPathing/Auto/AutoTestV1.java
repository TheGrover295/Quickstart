...
public class AutoTestV1 extends OpMode {
    ...
    public void buildPaths(){
        ...
        driveStartPosShootPos = follower.pathBuilder()
                ...
                .build();
        driveGrabReadyPOS = follower.pathBuilder()
                .addPath(new BezierLine(shootPose, grabreadyPose))
                .setLinearHeadingInterpolation(shootPose.getHeading(), grabreadyPose.getHeading())
                .build();
    }
    ...
    public void StatePathUpdate(){
        switch(pathState) {
            ...
            case SHOOT_PRELOAD:
                ...
                break;
            case DRIVE_GRABREADY:
                if (!follower.isBusy()){
                    telemetry.addLine("Done Path 2/ Grab Ready Pos");
                }
